...
> **3줄 요약**
> 1. 2025년 병원비 본인부담금이 **내 소득구간 상한액**을 넘으면 초과분을 돌려받습니다.
> 2. **지금 지급되는 것은 2025년 기준**입니다. 2026년 표와 다릅니다.
> 3. 안내문을 기다리지 말고 직접 조회하세요. **신청 기한은 3년**입니다.
...
*소득분위는 세대(주민등록상 함께 묶인 가구)별 연평균 보험료를 기준으로 나눕니다. 1분위가 가장 낮습니다.*
...
| 방식 | 언제 | 어떻게 |
|---|---|---|
| **사전급여** | 진료 중에 바로 | 같은 병원에서 그 해 본인부담금이 상한액을 넘으면, 환자는 상한액까지만 내고 넘는 금액은 병원이 공단에 청구합니다 |
| **사후환급** | 다음해 8월말경 | 여러 병원에서 낸 1년치 본인부담금을 합산해, 넘는 금액을 공단이 환자에게 돌려줍니다 |

대부분은 **사후환급**에 해당합니다. 한 병원에서만 큰 금액을 쓰는 경우는 드물기 때문입니다.
...
반대로 **여러 병원과 약국에 흩어져 있어도 전부 더해집니다.** 동네 의원, 대학병원, 약국을 다 합칩니다. 그래서 큰 수술 한 번이 없어도 만성질환으로 자주 다녔다면 대상이 될 수 있습니다.
...
**요양병원 입원일수가 120일을 넘으면 상한액이 따로 적용됩니다.** 금액이 올라갑니다.
...
같은 병원에서 그 해 본인부담금이 상한액을 넘으면, 병원이 그 자리에서 상한액까지만 받고 나머지는 공단에 청구합니다(사전급여). 이 경우 돌려받을 것이 남아 있지 않습니다.
...
같은 병원에서 그 해 낸 본인부담금이 최고상한액을 넘으면, 그 시점부터는 환자가 더 내지 않습니다. **2026년 기준 사전급여 최고상한액은 843만원**입니다.
...
**요양병원은 사전급여 대상에서 빠집니다.** 장기 입원 중이더라도 병원에서 바로 정리되지 않고, 다음해 8월 사후환급으로만 받습니다.
...
한 번에 큰 금액을 쓴 적이 없어서 "나는 아니겠지" 하고 넘어갑니다. 하지만 이 제도는 **1년치를 전부 더합니다.** 만성질환으로 매달 병원과 약국에 다녔다면 합산 금액이 생각보다 큽니다.
...
영수증 총액이 아니라 **급여 항목의 본인부담금만** 합산하기 때문입니다. 비급여, 선별급여, 전액 본인부담, 2~3인실 입원료, 임플란트 등은 빠집니다.
...
해당 연도의 요양병원 입원일수를 합산합니다. 120일을 넘으면 상한액이 올라간 표가 적용됩니다.
...
결제 수단과 무관합니다. 급여 항목의 본인부담금인지만 봅니다.

---

**정리하면** — 8월에 나오는 환급은 **작년에 낸 병원비**를 합산한 결과이고, 그래서 **작년 기준 금액**을 봐야 합니다. 2025년 진료분이라면 1분위 89만원 ~ 10분위 826만원이 기준선입니다.

안내문을 기다리지 말고 **The건강보험 앱이나 1577-1000으로 직접 조회**하세요. 재작년 것이 남아 있는지도 함께 나옵니다. **기한은 3년입니다.**
